...
if (0 < $qry->num_rows) {
	while ($row = $qry->fetch_assoc()) {
		...
		echo $row['name'];
		echo '</h1>' . "\r\n" . '                  <p class="SorteioTpl_descricao__1b7iL" style="margin-bottom:px">';
