...
class Master extends DBConnection
{
	...
	public function save_product()
	{
		...
		// Múltiplas sequências de cotas de rua (JSON)
		$cotas_rua_ranges_raw = isset($_POST['cotas_rua_ranges_json']) ? $_POST['cotas_rua_ranges_json'] : '[]';
		$cotas_rua_ranges_decoded = json_decode($cotas_rua_ranges_raw, true);
		$cotas_rua_ranges = (!is_array($cotas_rua_ranges_decoded)) ? '[]' : json_encode($cotas_rua_ranges_decoded);
		$cotas_rua_ranges = $this->conn->real_escape_string($cotas_rua_ranges);
