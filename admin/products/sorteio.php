                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-sm">
                                    <div class="relative  w-8 h-8 mr-3 rounded-full block">
                                        <img class="object-cover w-full h-full rounded-full" src="<?php echo BASE_URL ?>uploads/avatars/1.png?v=1649834664" alt="" loading="lazy">
                                ...
                                <td id="user-whatsapp" class="px-4 py-3">
                                    <a href="" class="send-whatsapp">
                                        <img src="<?php echo BASE_URL ?>admin/assets/img/whatsapp.png" style="height: 30px">
                                    </a>
...
alert('Sorteio gerado com sucesso');
    ...
    function updateUserInfo(resp) {
        ...
        <img src="${_BASE_URL_}admin/assets/img/whatsapp.png" style="height: 30px">
                </a>`);
